...
\usepackage[top=0.4in,bottom=0.1in,left=0.72in]{geometry}

\name{BRIAN HUANG\\[6pt]}
%\vspace{-0.3in}

\address{ \\ \href{http://www.bupt.edu.cn/}{Beijing University of Posts and Telecommunications}
\\No.10, Xitucheng Road, Haidian District
\\Beijing, China, 100876}

\address{ \\Mobile: ($+$86) 130-8266-3782
\\Email: \href{mailto:binglianghuang@gmail.com}{\tt binglianghuang@gmail.com}
\\Blog: \href{http://blog.csdn.net/souldak}
  {\tt http://blog.csdn.net/souldak}
\\GitHub: \href{https://github.com/evagle}
  {\tt https://github.com/evagle}
\\English: GRE 323
}
\begin{document}
